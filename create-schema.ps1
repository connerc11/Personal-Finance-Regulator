# Simple database initialization for Spring Boot apps
# Since Spring Boot with ddl-auto: update will create tables automatically,
# we just need to ensure the database exists

Write-Host "=== Creating Database Schema Directly ==="

# For now, let's create a simple SQL schema that Spring Boot can use
$schemaSQL = @"
...
VALUES 
    (1, 'demo', 'demo@example.com', '${'$'}2a${'$'}10${'$'}TKh9yE9J7Jv9YrJ5J8Z7K.rJ5J8Z7K.rJ5J8Z7K.rJ5J8Z7K.rJ5J8', 'Demo', 'User'),
    (2, 'user', 'user@example.com', '${'$'}2a${'$'}10${'$'}TKh9yE9J7Jv9YrJ5J8Z7K.rJ5J8Z7K.rJ5J8Z7K.rJ5J8Z7K.rJ5J8', 'Test', 'User')
...
$schemaSQL | Out-File -FilePath "database-schema.sql" -Encoding UTF8

Write-Host "✅ Database schema file created: database-schema.sql"
Write-Host "This schema will be automatically applied by Spring Boot when services start."
Write-Host "Sample data includes user ID 2 with transactions and budgets."
